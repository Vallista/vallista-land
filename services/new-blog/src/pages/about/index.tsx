      ...
      <div className={styles.header}>
        <div className={styles.wrapper}>
          <header className={styles.title}>
            <span className={styles.textSpan}>안녕하세요.</span>
            <h1 className={styles.textH1}>
              저는 <span className={styles.textHighlight}>마광휘</span>
              입니다.
            </h1>
          </header>
          <article className={styles.subTitle}>
            <p className={styles.textP}>
              대한민국 서울, 잠실의 우아한형제들에서 <span className={styles.textBold}>시니어 소프트웨어 엔지니어</span>
